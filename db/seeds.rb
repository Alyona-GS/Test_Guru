...
tests = Test.create([
  { title: 'Control Flow',                        category_id: categories[0].id, user_id: users[0].id },
  { title: 'Metaprogramming',           level: 3, category_id: categories[0].id, user_id: users[0].id },
  { title: 'Text formatting',                     category_id: categories[1].id, user_id: users[0].id },
  { title: 'Dictionaries',              level: 2, category_id: categories[2].id, user_id: users[0].id },
  { title: 'Blocs, Procs, and Lambdas', level: 2, category_id: categories[0].id, user_id: users[0].id } ])
...
User.first.tests << tests[0]
User.first.tests << tests[2]
User.last.tests << tests[1]